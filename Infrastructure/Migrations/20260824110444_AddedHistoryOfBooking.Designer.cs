...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260824110444_AddedHistoryOfBooking")]
    partial class AddedHistoryOfBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Common.BookingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BookingId", "ChangedByUserId", "CreatedAt");
            ...
            modelBuilder.Entity("Domain.Entities.Common.NotificationRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NotificationId", "UserAccountId", "DeliveryStatus", "DeliveryAttempts", "CreatedAt");

                    b.ToTable("NotificationRecipients");
                });

            modelBuilder.Entity("Domain.Entities.Common.OutboxMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Status", "Attempts", "CreatedAt");

                    b.ToTable("OutboxMessages");
                });

            modelBuilder.Entity("Domain.Entities.Common.PromoCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MinBookingPrice")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.CompanyReleated.EmployeeService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Common.Booking", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Common.PromoCode", "PromoCode")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Domain.Entities.Common.NotificationRecipient", b =>
                {
                    b.HasOne("Domain.Entities.Common.Notification", "Notification")
                        .WithMany("Recipients")
